...
public class Driver {
	...
	Job job_obj = new Job(conf, "Flight Analysis");
	// setting name of main class
	job_obj.setJarByClass(Driver.class);
	//name of mapper class
	job_obj.setMapperClass(FlightMapper.class);
		// name of reducer class
	job_obj.setReducerClass(FlightReducer.class);

        job_obj.setMapOutputKeyClass(Text.class);
        job_obj.setMapOutputValueClass(FlightWritable.class);
	...
	FileInputFormat.addInputPath(job_obj, input_path);
        ...
        MultipleOutputs.addNamedOutput(job_obj,"High", TextOutputFormat.class, Text.class, LongWritable.class);
       	MultipleOutputs.addNamedOutput(job_obj,"Low", TextOutputFormat.class, Text.class, LongWritable.class);		
